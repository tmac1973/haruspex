...
// Size limits still used by the doc-builder Tauri commands left in this
// file (fs_write_pdf, fs_write_docx, etc.). When the per-format modules
// land, each will own its own size cap.
