...
# extraction. Delegated to fetch-pdfium.sh (the single download path, shared
# with dev-setup.sh and the Makefile's ensure-pdfium target).
"$SCRIPT_DIR/fetch-pdfium.sh" --target "$TARGET"
echo
