 ...
 */
export type MemoryHit = { score: number, similarity: number, id: string, content: string, category: string, source_conversation_id: string | null, created_at: number, last_seen_at: number, use_count: number, };
